...
#define DS2_POS PB0          //position of the data pin(DS)
#define SH2_CP_POS PB1       //position of the shift clock(SH_CP)
#define ST2_CP_POS PB2       //position of the store clock(ST_CP)
//----------------------------------
