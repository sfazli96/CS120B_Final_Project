...
#define DS_POS PB3          //position of the data pin(DS)
#define SH_CP_POS PB4      //position of the shift clock(SH_CP)
#define ST_CP_POS PB5       //position of the store clock(ST_CP)
//----------------------------------
